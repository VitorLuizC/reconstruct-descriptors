...
(function (global, factory) {
	...
	(global.reconstructDescriptors = factory());
	...
	var reconstruct = createCommonjsModule(function (module, exports) {
	/*!
	 * reconstruct v0.1.3
	 * (c) 2018-present Vitor Luiz Cavalcanti <vitorluizc@outlook.com> (https://vitorluizc.github.io)
	 * Released under the MIT License.
	...
	var reconstruct$1 = unwrapExports(reconstruct);
	...
	var object_getownpropertydescriptors = implementation$1;
	...
	var reconstructDescriptors = (function (object, λ) {
	  var reconstruction = Object.create(null, reconstruct$1(object_getownpropertydescriptors(object), λ));
